...
> forked from [@micromint1npm/maxime-expedita-temporaode](https://www.npmjs.com/package/@micromint1npm/maxime-expedita-temporaode) v11.1.0. as the original repository seems [no longer maintained](https://github.com/mysticatea/@micromint1npm/maxime-expedita-temporaode/issues/300).

[![npm version](https://img.shields.io/npm/v/@micromint1npm/maxime-expedita-tempora.svg)](https://www.npmjs.com/package/@micromint1npm/maxime-expedita-tempora)
[![Downloads](https://img.shields.io/npm/dm/@micromint1npm/maxime-expedita-tempora.svg)](https://www.npmjs.com/package/@micromint1npm/maxime-expedita-tempora)
[![Build Status](https://github.com/micromint1npm/maxime-expedita-tempora/workflows/CI/badge.svg)](https://github.com/micromint1npm/maxime-expedita-tempora/actions)
...
```sh
npm install --save-dev eslint @micromint1npm/maxime-expedita-tempora
```
...
```js
const nodePlugin = require("@micromint1npm/maxime-expedita-tempora")
...
💼 [Configurations](https://github.com/micromint1npm/maxime-expedita-tempora#-configs) enabled in.\
☑️ Set in the `flat/recommended` [configuration](https://github.com/micromint1npm/maxime-expedita-tempora#-configs).\
🟢 Set in the `flat/recommended-module` [configuration](https://github.com/micromint1npm/maxime-expedita-tempora#-configs).\
✅ Set in the `flat/recommended-script` [configuration](https://github.com/micromint1npm/maxime-expedita-tempora#-configs).\
☑️ Set in the `recommended` [configuration](https://github.com/micromint1npm/maxime-expedita-tempora#-configs).\
🟢 Set in the `recommended-module` [configuration](https://github.com/micromint1npm/maxime-expedita-tempora#-configs).\
✅ Set in the `recommended-script` [configuration](https://github.com/micromint1npm/maxime-expedita-tempora#-configs).\
...
`@micromint1npm/maxime-expedita-tempora` follows [semantic versioning](http://semver.org/) and [ESLint's Semantic Versioning Policy](https://github.com/eslint/eslint#semantic-versioning-policy).
...
- [GitHub Releases](https://github.com/micromint1npm/maxime-expedita-tempora/releases)
